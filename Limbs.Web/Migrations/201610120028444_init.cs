namespace Limbs.Web.Migrations
{
    ...
    public partial class init : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        IsRightHand = c.Boolean(nullable: false),
                    })
                .PrimaryKey(t => t.Id);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.FileModels", "ProductModel_Id", "dbo.ProductModels");
            DropForeignKey("dbo.FileModels", "FileModel_Id", "dbo.FileModels");
            ...
            DropIndex("dbo.FileModels", new[] { "ProductModel_Id" });
            DropIndex("dbo.FileModels", new[] { "FileModel_Id" });
